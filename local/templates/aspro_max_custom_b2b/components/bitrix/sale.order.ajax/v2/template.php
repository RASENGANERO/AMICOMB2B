...
$APPLICATION->AddViewContent('more_text_title', '<div class="basket-back font_xs"><a href="/b2b/catalog/" class="basket-back__link muted">'.Loc::getMessage('GO_TO_BASKET').'</a></div>');
?>
	<NOSCRIPT>
