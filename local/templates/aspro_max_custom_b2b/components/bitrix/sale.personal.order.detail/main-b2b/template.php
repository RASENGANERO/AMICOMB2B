	...
	<div class="container-fluid sale-order-detail">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-general">
			...
			<div class="row sale-order-detail-total-payment">
				<div class="order-b2b-container-detail col-md-7 col-md-offset-5 col-sm-12 col-xs-12 sale-order-detail-total-payment-container">
					<div class="order-b2b-row row">
						
						<div class="sale-order-detail-b2b col-md-4 col-sm-6 col-xs-6 sale-order-detail-total-payment-list-right">
							<?if (intval($arResult['DELIVERY']['ID']) === 2):?>
								<span class="sale-order-detail-total-payment-list-right-item"><?=Loc::getMessage('SPOD_DELIVERY').': '.Loc::getMessage('SPOD_DELIVERY_MANAGER')?></span>
								<span class="sale-order-detail-total-payment-list-right-item"><?=Loc::getMessage('SPOD_SUMMARY').': '.$arResult['PRODUCT_SUM_FORMATED']?></span>
							<?else:?>
								<span class="sale-order-detail-total-payment-list-right-item"><?=Loc::getMessage('SPOD_DELIVERY').': 0'?></span>
								<span class="sale-order-detail-total-payment-list-right-item"><?=Loc::getMessage('SPOD_SUMMARY').': '.$arResult['PRODUCT_SUM_FORMATED']?></span>
							<?endif;?>
						</div>
					</div>
