		...
		<div class="">
			<?if($arResult["SECTIONS"]):?>
				<div class="section-detail-list__item item font_xs " >
					<div class="section-detail-list__info bordered box-shadow-sm rounded3 all-sections section-detail-list__item--active colored_theme_bg" data-section_reset="false">
