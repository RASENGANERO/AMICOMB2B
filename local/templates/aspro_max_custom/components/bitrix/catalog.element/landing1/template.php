...
<?if($arResult['PROPERTIES']['TIZERS']['VALUE']):?>
	<?$GLOBALS["arLandingTizers"] = ["ID" => $arResult['PROPERTIES']['TIZERS']['VALUE']];?>
	...
	<?if($bShowFormQuestion):?>
		<div class="col-md-<?=($arResult["PREVIEW_TEXT"] ? 3 : '3 pull-left')?>">
			<div class="ask_a_question">
				...
				<div class="outer">
					<span><span class="btn btn-default btn-lg white transparent animate-load" data-event="jqm" data-param-form_id="ASK" data-name="question"><span><?=(strlen((string) $arParams['S_ASK_QUESTION']) ? $arParams['S_ASK_QUESTION'] : Loc::getMessage('S_ASK_QUESTION'))?></span></span></span>
				</div>
			</div>
		</div>
	<?endif;?>
...
<?if($arResult["PROPERTIES"]["SECTION"]["VALUE"]):?>
	<?$GLOBALS["arLandingSections"] = ["PROPERTY_SECTION" => $arResult["PROPERTIES"]["SECTION"]["VALUE"], "!ID" => $arResult["ID"]];?>
