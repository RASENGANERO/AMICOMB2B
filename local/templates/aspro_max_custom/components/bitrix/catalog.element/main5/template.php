									...
									<div class="brand-detail">
										<div class="brand-detail-info bordered rounded3">
											...
											<div class="brand-detail-info__preview">
												...
												<?endif;?>
												<div class="link font_xs"><a href="<?=$arResult['BRAND_ITEM']["DETAIL_PAGE_URL"];?>" target="_blank"><?=GetMessage("ITEMS_BY_BRAND", ["#BRAND#" => $arResult['BRAND_ITEM']["NAME"]])?></a></div>
											</div>
										</div>
									</div>
								<?endif;?>
					...
					<div class="product-chars">
						...
						<?if ($arParams['VISIBLE_PROP_COUNT'] > 0):?>
							<div class="info_ext_block char-toggle-visible <?=($isShowProps ? '' : 'hidden')?>">
								<div class="title opened font_upper_md darken colored_theme_hover_text colored_theme_hover_bg_before"><?=($arParams["T_CHARACTERISTICS"] ?: Loc::getMessage("T_CHARACTERISTICS"));?></div>
						...
						<?if($arParams['SHOW_GARANTY'] != 'N'):?>
							<div class="info_ext_block">
								...
								<div class="text text--with-pt font_xs">
									<?$APPLICATION->IncludeFile(SITE_DIR."include/element_detail_garanty.php", [], ["MODE" => "html",  "NAME" => $arParams['TITLE_GARANTY']]);?>
								</div>
							</div>
						<?endif;?>
						<?if($arParams['SHOW_BUY_DELIVERY'] != 'N'):?>
							<div class="info_ext_block">
								...
								<div class="text text--with-pt font_xs">
									<?$APPLICATION->IncludeFile(SITE_DIR."include/element_detail_buy_delivery.php", [], ["MODE" => "html",  "NAME" => $arParams['TITLE_BUY_DELIVERY']]);?>
								</div>
							</div>
						<?endif;?>
					</div>
