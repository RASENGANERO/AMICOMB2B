...
if(($arResult["DISPLAY_PROPERTIES"]["BRAND"]["VALUE"] ?? false) && $arResult["PROPERTIES"]["BRAND"]["LINK_IBLOCK_ID"]){
	...
	if($arBrand){
		if($arParams["SHOW_BRAND_PICTURE"] == "Y" && ($arBrand["PREVIEW_PICTURE"] || $arBrand["DETAIL_PICTURE"])){
			$arBrand["IMAGE"] = CFile::ResizeImageGet(($arBrand["PREVIEW_PICTURE"] ?: $arBrand["DETAIL_PICTURE"]), ["width" => 200, "height" => 40], BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true);
		}
	}
}

$arResult["BRAND_ITEM"] = $arBrand;
$arResult["ARTICLE"] = (strlen((string) $arResult["DISPLAY_PROPERTIES"]["CML2_ARTICLE"]["VALUE"]) && $arResult["PROPERTIES"]["CML2_ARTICLE"]["VALUE"]);
