								...
								<div class="body-info">
									<div class="description">
										<div class="product_name">
											<?if(strlen((string) $arItem["DETAIL_PAGE_URL"]) > 0):?><a class="dark_link" href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?endif;?><?=$arItem["NAME"]?><?if (strlen((string) $arItem["DETAIL_PAGE_URL"]) > 0):?></a><?endif;?>
										</div>
