...
if($arResult['ITEMS']){?>
	<?$arResult['RID'] = ($arResult['RID'] ?: (\Bitrix\Main\Context::getCurrent()->getRequest()->get('RID') != 'undefined' ? \Bitrix\Main\Context::getCurrent()->getRequest()->get('RID') : ''));?>
						...
						<div class="block-item__inner flexbox flexbox--row">
							...
							<div class="block-item__info item_info">
								...
								<div class="block-item__cost cost prices clearfix">
									<?if($arItem["OFFERS"]):?>
										<?\Aspro\Functions\CAsproMaxSku::showItemPrices($arParams, $arItem, $item_id, $min_price_id, [], 'Y');?>
									<?else:?>
										<?
