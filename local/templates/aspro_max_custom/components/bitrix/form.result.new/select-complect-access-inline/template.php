...
Asset::getInstance()->addCss('/local/templates/aspro_max_custom/components/bitrix/form.result.new/select-complect-access-inline/style.css');
Asset::getInstance()->addJs('/local/templates/aspro_max_custom/components//bitrix/form.result.new/select-complect-access-inline/main.js');
?>
...
?>
<div class="maxwidth-cust maxwidth-theme">
	<div class="form inline <?= $arResult["arForm"]["SID"] ?>">
		<!--noindex-->
		<?php 
if ($arResult["isFormErrors"] == "Y" || strlen((string) $arResult["FORM_NOTE"])): ?>
...
?>
		...
		<?php 
if ($arParams['HIDE_SUCCESS'] != 'Y' || ($arParams['HIDE_SUCCESS'] == 'Y' && !strlen((string) $arResult["FORM_NOTE"]))): ?>
