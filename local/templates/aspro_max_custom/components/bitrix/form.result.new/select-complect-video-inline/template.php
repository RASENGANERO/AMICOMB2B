...
Asset::getInstance()->addCss('/local/templates/aspro_max_custom/components/bitrix/form.result.new/select-complect-video-inline/style.css');
Asset::getInstance()->addJs('/local/templates/aspro_max_custom/components//bitrix/form.result.new/select-complect-video-inline/main.js');
?>
