...
$bImage = (isset($arResult["FIELDS"]["DETAIL_PICTURE"]) && strlen((string) $arResult["FIELDS"]["DETAIL_PICTURE"]['SRC']) ? true : false);
?>
	...
	<div class="content">
		<?if($bImage || $arResult["DISPLAY_PROPERTIES"]):?>
			<div class="top_content ">
				<?if($bImage):?>
					<div class="image"><img class="img-responsive" src="<?=$arResult["FIELDS"]["DETAIL_PICTURE"]['SRC']?>" alt="<?=($arResult["FIELDS"]["DETAIL_PICTURE"]['ALT'] ?: $arResult['NAME']);?>" title="<?=($arResult["FIELDS"]["DETAIL_PICTURE"]['TITLE'] ?: $arResult['NAME']);?>" /></div>
				<?endif;?>
						...
						<div class="row">
							...
							<?foreach($arResult["DISPLAY_PROPERTIES"] as $PCODE => $arProperty):?>
								...
								if($arProperty['PROPERTY_TYPE'] == 'E' || $arProperty['PROPERTY_TYPE'] == 'G')
									continue;
								?>
								<div class="property <?=strtolower((string) $PCODE);?> col-md-3 col-sm-3 col-xs-6">
