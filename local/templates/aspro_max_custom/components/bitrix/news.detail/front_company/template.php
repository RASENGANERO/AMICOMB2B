									...
									<?ob_start();?>
										<div class="buttons">
											<?if(isset($arResult['DISPLAY_PROPERTIES']['URL']) && strlen($arResult['DISPLAY_PROPERTIES']['URL']['VALUE'])):?>
												<a class="btn <?=(!$bNoImg ? 'btn-default' : 'btn-transparent-border-color');?>" href="/about/"><span><?=(strlen($arResult['PROPERTIES']['MORE_BUTTON_TITLE']['VALUE']) ? $arResult['PROPERTIES']['MORE_BUTTON_TITLE']['VALUE'] : Loc::getMessage('S_TO_SHOW_ALL_MORE'))?></span></a>
											<?endif;?>
										</div>
