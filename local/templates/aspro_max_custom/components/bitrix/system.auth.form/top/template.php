...
<?else:?>
	<div class="module-enter have-user">
		...
		global $USER;
		$arPhoto=[];
		$arUser=CMaxCache::CUser_GetList(["SORT"=>"ASC", "CACHE" => ["MULTI" => "N", "TAG"=>CMaxCache::GetUserCacheTag($USER->GetID())]], ["ID"=>$USER->GetID()], ["FIELDS"=>["ID", "PERSONAL_PHOTO"]]);
		if($arUser["PERSONAL_PHOTO"]){
			$arPhoto=CFile::ResizeImageGet($arUser["PERSONAL_PHOTO"], ["width"=>21, "height"=>21], BX_RESIZE_IMAGE_EXACT, true);
		}
		?>
		<!--noindex-->
