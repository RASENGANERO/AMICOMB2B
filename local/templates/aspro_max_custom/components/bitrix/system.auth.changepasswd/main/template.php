...
$lastLogin = ($_SESSION['lastLoginSave'] ?? $arResult["LAST_LOGIN"]?:'');
global $arTheme;
?>
<div class="changepasswd-page pk-page">
	...
	<?else:?>
		...
		if(isset($_POST['USER_PASSWORD']) && strlen((string) $_POST['USER_PASSWORD']) < 6){
		...
		if(isset($_POST['USER_CONFIRM_PASSWORD']) && strlen((string) $_POST['USER_CONFIRM_PASSWORD']) < 6 ){
