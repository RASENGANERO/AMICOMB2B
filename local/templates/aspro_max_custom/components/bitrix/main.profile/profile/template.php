...
[$bPhoneAuthSupported, $bPhoneAuthShow, $bPhoneAuthRequired, $bPhoneAuthUse] = Aspro\Max\PhoneAuth::getOptions();
?>
<div class="module-form-block-wr lk-page border_block">
	...
	<div class="form-block-wr">
		...
		<?else:?>
				...
				<div class="form-control">
					<div class="wrap_md">
						<div class="iblock label_block">
							...
							<?
							if(strlen((string) $arResult["arUser"]["PERSONAL_PHONE"]) && !str_contains((string) $arResult["arUser"]["PERSONAL_PHONE"], '+') && str_contains($mask, '+')){
					...
					<div class="form-control">
						<div class="wrap_md">
							<div class="iblock label_block">
								...
								<?
								if(strlen((string) $arResult["arUser"]["PHONE_NUMBER"]) && !str_contains((string) $arResult["arUser"]["PHONE_NUMBER"], '+') && str_contains($mask, '+')){
			...
			<?if($arResult["SOCSERV_ENABLED"]){ $APPLICATION->IncludeComponent("bitrix:socserv.auth.split", "main", ["SUFFIX"=>"form", "SHOW_PROFILES" => "Y","ALLOW_DELETE" => "Y"],false);}?>
		<?endif;?>
	</div>
	<script>
