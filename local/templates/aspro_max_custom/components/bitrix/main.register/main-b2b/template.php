			...
			<div class="form">
				<form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" >
					...
					<div class="form_body">
													...
													<?if($arUFields):?>
														...
														<?foreach($arUFields as $arUField):?>
															<?if ($arUField['FIELD_NAME'] === 'UF_INNORG'):?>
																...
																<label for="input_UF_INNORG"><span><?=$arUField["EDIT_FORM_LABEL"];?>&nbsp;<?if ($arUField["MANDATORY"] == "Y"):?><span class="star">*</span><?endif;?></span></label>
						...
						<?if($arUFields):?>
							<?foreach($arUFields as $arUField):?>
									<div class="form-control-hide form-control">
										...
										["bVarsFromForm" => $arResult["bVarsFromForm"], "arUserField" => $arUField, "form_name" => "regform"], null, ["HIDE_ICONS"=>"Y"]);?>
									</div>
							<?endforeach;?>
						<?endif;?>
