                        ...
                        <div class="services-item__inner flexbox flexbox--row">
                            <div class="services-item__info item_info">
                                ...
                                <div class="services-item__title js-notice-block__title">
                                    <span class="dark-color dotted" data-event="jqm" data-no-mobile="Y" data-param-form_id="fast_view_services" data-param-item_href=<?=urlencode((string) $arItem["DETAIL_PAGE_URL"]);?> data-name="fast_view_services" data-param-iblock_id="<?=$arItem["IBLOCK_ID"];?>" data-param-id="<?=$arItem["ID"];?>" >
                                        <?=$elementName;?>
                                    </span>
                                </div> 
                                <div class="services-item__buy">
                                    ...
                                    $totalCount = 999;
                                    $arItem["CAN_BUY"] = true;
                                    $arParams['PRODUCT_PROPERTIES'] = ['BUY_PRODUCT_PROP'];
