				...
				<div class="list_item item_info catalog-adaptive flexbox flexbox--row <?=($arItem["OFFERS"] ? 'has-sku' : '')?>" id="<?=$arItemIDs["strMainID"];?>">
					...
					<div class="image_block">
						...
						<?if($bNormalView && ($arParams['USE_FAST_VIEW'] != 'N')):?>
							...
							<?if(!$bComplect):?>
								<div class="fast_view_block rounded2 btn btn-xs font_upper_xs btn-transparent" data-event="jqm" data-param-form_id="fast_view" data-param-iblock_id="<?=$arParams["IBLOCK_ID"];?>" data-param-id="<?=$arItem["ID"];?>" data-param-item_href="<?=urlencode((string) $arItem["DETAIL_PAGE_URL"]);?>" data-name="fast_view">
