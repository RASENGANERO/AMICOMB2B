...
<div class="subscribe-form s_<?=$id;?>">
	<div class="wrap_bg">
		<div class="top_blocks">
			<div class="text">
				<div class="title"><?$APPLICATION->IncludeFile(SITE_DIR."include/subscribe_title.php", [], ["MODE" => "html", "NAME" => GetMessage("TOP_BLOCK"),]);?></div>
				<div class="more"><?$APPLICATION->IncludeFile(SITE_DIR."include/subscribe_text.php", [], ["MODE" => "html", "NAME" => GetMessage("TEXT_BLOCK"),]);?></div>
			</div>
		</div>
