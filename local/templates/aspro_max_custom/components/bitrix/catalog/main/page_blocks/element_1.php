...
<div class="product-view product-view--side-left <?=($sViewPictureDetail === 'square_big' ? 'product-view--big-gallery' : '')?>">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		[
			...
			"DETAIL_PICTURE_MODE" => ($arTheme["DETAIL_PICTURE_MODE"]["VALUE"] ?? 'POPUP'),
			...
			"TAB_OFFERS_NAME" => ($arParams["TAB_OFFERS_NAME"] ?: GetMessage("OFFER_PRICES")),
			"TAB_VIDEO_NAME" => ($arParams["TAB_VIDEO_NAME"] ?: GetMessage("VIDEO_TAB")),
			"TAB_BUY_SERVICES_NAME" => ($arParams["TAB_BUY_SERVICES_NAME"] ?: GetMessage("BUY_SERVICES_TAB")),
			"TAB_REVIEW_NAME" => ($arParams["TAB_REVIEW_NAME"] ?: GetMessage("REVIEW_TAB")),
			"TAB_FAQ_NAME" => $arParams["TAB_FAQ_NAME"],
			"TAB_STOCK_NAME" => ($arParams["TAB_STOCK_NAME"] ?: GetMessage("STORES_TAB")),
			"TAB_NEWS_NAME" => ($arParams["TAB_NEWS_NAME"] ?: GetMessage("TAB_NEWS_NAME")),
			"TAB_DOPS_NAME" => ($arParams["TAB_DOPS_NAME"] ?: GetMessage("ADDITIONAL_TAB")),
			"TAB_STAFF_NAME" => ($arParams["TAB_STAFF_NAME"] ?: GetMessage("TAB_STAFF_NAME")),
			"TAB_VACANCY_NAME" => ($arParams["TAB_VACANCY_NAME"] ?: GetMessage("TAB_VACANCY_NAME")),
			"TAB_BLOG_NAME" => ($arParams["BLOCK_BLOG_NAME"] ?: GetMessage("TAB_BLOG_NAME")),
			"BLOCK_SERVICES_NAME" => ($arParams["BLOCK_SERVICES_NAME"] ?: GetMessage("SERVICES_TITLE")),
			"BLOCK_DOCS_NAME" => ($arParams["BLOCK_DOCS_NAME"] ?: GetMessage("DOCUMENTS_TITLE")),
			...
			"BLOCK_ADDITIONAL_GALLERY_NAME" => ($arParams["BLOCK_ADDITIONAL_GALLERY_NAME"] ?: GetMessage("BLOCK_ADDITIONAL_GALLERY_NAME")),
			...
			"SHOW_PAYMENT" => ($arParams["SHOW_PAYMENT"] ?? "Y"),
			"SHOW_DELIVERY" => ($arParams["SHOW_DELIVERY"] ?? "Y"),
			"SHOW_HOW_BUY" => ($arParams["SHOW_HOW_BUY"] ?? "Y"),
			"TITLE_HOW_BUY" => ($arParams["TITLE_HOW_BUY"] ?: GetMessage("TITLE_HOW_BUY")),
			"TITLE_DELIVERY" => ($arParams["TITLE_DELIVERY"] ?: GetMessage("TITLE_DELIVERY")),
			"TITLE_PAYMENT" => ($arParams["TITLE_PAYMENT"] ?: GetMessage("TITLE_PAYMENT")),
			...
			"DETAIL_BLOCKS_ORDER" => ($arParams["DETAIL_BLOCKS_ORDER"] ?: 'complect,nabor,offers,tabs,services,news,blog,staff,vacancy,goods'),
			"DETAIL_BLOCKS_TAB_ORDER" => ($arParams["DETAIL_BLOCKS_TAB_ORDER"] ?: 'desc,char,buy,payment,delivery,video,stores,reviews,custom_tab,buy_services'),
			"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ?: 'complect,nabor,offers,desc,char,buy,payment,delivery,video,stores,custom_tab,services,news,reviews,blog,staff,vacancy,goods,buy_services'),
			"COUNT_SERVICES_IN_ANNOUNCE" => ($arParams["COUNT_SERVICES_IN_ANNOUNCE"] ?? '2') ,
			"SHOW_ALL_SERVICES_IN_SLIDE" => ($arParams["SHOW_ALL_SERVICES_IN_SLIDE"] ?? 'N') ,
			"FILTER_NAME" => $arParams["FILTER_NAME"],
			"DISPLAY_LINKED_PAGER" => ($arParams["DETAIL_LINKED_GOODS_SLIDER"] == "Y") ? "N" : $arParams["DISPLAY_LINKED_PAGER"],
			"DETAIL_SET_PRODUCT_TITLE" => ($arParams["DETAIL_SET_PRODUCT_TITLE"] ?: GetMessage("DETAIL_SET_PRODUCT")),
			...
			"SHOW_CHARACTERS" => $arParams["SHOW_CHARACTERS"],
			"TITLE_CHARACTERS" => $arParams["TITLE_CHARACTERS"],

			"SMART_SEO_PARAMETERS" => [
				"MODE" => "Y",
	...
	<?if($arParams['SHOW_ASK_BLOCK'] == 'Y'):?>
		<div class="side-block side-block--feedback rounded2 bordered box-shadow colored_theme_hover_bg-block">
			...
			<div class="side-block__bottom side-block__bottom--last">
				<span class="btn btn-lg btn-transparent btn-wide round-ignore font_upper animate-load colored_theme_hover_bg-el has-ripple" data-event="jqm" data-param-form_id="ASK" data-name="ask"><?=($arParams["ASK_TAB"] ?: GetMessage("ASK_TAB"))?></span>
			</div>
		</div>
	<?endif;?>
</div>
