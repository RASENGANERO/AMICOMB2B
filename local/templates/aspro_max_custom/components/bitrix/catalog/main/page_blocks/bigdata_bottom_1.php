...
$arParams["RCM_TYPE"] = ($arParams['BIG_DATA_RCM_TYPE'] ?? '');
...
if ($arParams["BIGDATA_SET_COUNT_BOTTOM"] !== "N"){
     $arParams["BIGDATA_COUNT_BOTTOM"] = ($arParams['BIGDATA_COUNT_BOTTOM'] ?: 10);
} else {
    $arParams["BIGDATA_COUNT_BOTTOM"] = ($arParams['BIGDATA_COUNT'] ?: 10);
}
?>
