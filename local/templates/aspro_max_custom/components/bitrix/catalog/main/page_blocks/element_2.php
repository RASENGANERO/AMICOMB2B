...
<div class="product-view <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?> main_item_wrapper product-view--type2 <?=($sViewPictureDetail === 'square_big' ? 'product-view--big-gallery' : '')?>">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		[
			...
			"DETAIL_BLOCKS_ORDER" => ($arParams["DETAIL_BLOCKS_ORDER"] ?: 'complect,nabor,offers,tabs,services,news,blog,staff,vacancy,goods,modules'),
			...
			"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ?: 'complect,nabor,offers,desc,char,buy,payment,delivery,video,stores,custom_tab,services,news,reviews,blog,staff,vacancy,goods,buy_services,modules'),
