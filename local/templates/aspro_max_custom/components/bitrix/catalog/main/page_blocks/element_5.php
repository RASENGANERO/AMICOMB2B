...
<div class="product-view <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?> main_item_wrapper product-view--mix product-view--mix-wide <?=($sViewPictureDetail === 'square_big' ? 'product-view--big-gallery' : '')?>">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		[
			...
			"SET_LAST_MODIFIED" => "Y",
			"TITLE_PREVIEW" => ($arParams["TITLE_PREVIEW"] ?: GetMessage("TITLE_PREVIEW")),
			"SHOW_GARANTY" => $arParams["SHOW_GARANTY"],
			"TITLE_GARANTY" => ($arParams["TITLE_GARANTY"] ?: GetMessage("TITLE_GARANTY")),
			"SHOW_BUY_DELIVERY" => $arParams["SHOW_BUY_DELIVERY"],
			"TITLE_BUY_DELIVERY" => ($arParams["TITLE_BUY_DELIVERY"] ?: GetMessage("TITLE_BUY_DELIVERY")),
