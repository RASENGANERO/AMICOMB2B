function setNewHeader(obOffer) {
  ...
  priceHtml = String(priceHtml).replace('Розничная цена','РРЦ');
  priceHtml = String(priceHtml).replace('Оптовая цена','ОПТ');
  priceHtml = String(priceHtml).replace('class="prices-all-container"','class="prices-all-header prices-all-container"');
  priceHtml = String(priceHtml).replace('class="price-opt-text"','class="price-opt-header price-opt-text"');
  priceHtml = String(priceHtml).replace('class="price-retail-text"','class="price-retail-header price-retail-text"');
  priceHtml = String(priceHtml).replace('class="prices-all-item"','class="prices-all-item-header prices-all-item"')
  priceHtml = String(priceHtml).replace('class="values_wrapper"','class="values_wrapper_header values_wrapper"');
  //console.log(priceHtml);
  // setTimeout(function(){
  $("#headerfixed .logo-row").html(
    '<div class="ajax_load asd">' +
