...
{
	$arSection = CMaxCache::CIBlockSection_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ['GLOBAL_ACTIVE' => 'Y', "ID" => $arResult["VARIABLES"]["SECTION_ID"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]], false, ["ID", "IBLOCK_ID", "UF_SECTION_TIZERS", "NAME", "IBLOCK_SECTION_ID", "DEPTH_LEVEL", "LEFT_MARGIN", "RIGHT_MARGIN", "UF_OFFERS_TYPE", "UF_ELEMENT_DETAIL", "UF_HELP_TEXT", 'UF_LINKED_BLOG', "UF_PICTURE_RATIO"]);
}
elseif(strlen(trim((string) $arResult["VARIABLES"]["SECTION_CODE"])) > 0)
{
	$arSection = CMaxCache::CIBlockSection_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ['GLOBAL_ACTIVE' => 'Y', "=CODE" => $arResult["VARIABLES"]["SECTION_CODE"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]], false, ["ID", "IBLOCK_ID", "UF_SECTION_TIZERS", "NAME", "IBLOCK_SECTION_ID", "DEPTH_LEVEL", "LEFT_MARGIN", "RIGHT_MARGIN", "UF_OFFERS_TYPE", "UF_ELEMENT_DETAIL", "UF_HELP_TEXT", 'UF_LINKED_BLOG', "UF_PICTURE_RATIO"]);
}

if($arResult["VARIABLES"]["ELEMENT_ID"] > 0)
	$arElementFilter = ["IBLOCK_ID" => $arParams["IBLOCK_ID"], "ID" => $arResult["VARIABLES"]["ELEMENT_ID"]];
elseif(strlen(trim((string) $arResult["VARIABLES"]["ELEMENT_CODE"])) > 0)
...
$arElement = CMaxCache::CIBLockElement_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], CMax::makeElementFilterInRegion($arElementFilter), false, false, ["ID", "IBLOCK_ID", "IBLOCK_SECTION_ID", "NAME", "PREVIEW_TEXT", "PREVIEW_PICTURE", "DETAIL_PICTURE", "PROPERTY_ASSOCIATED_FILTER", "PROPERTY_EXPANDABLES_FILTER", "PROPERTY_ASSOCIATED", "PROPERTY_EXPANDABLES", "TYPE"]);
...
if(!$arSection)
{
	if($arElement["IBLOCK_SECTION_ID"])
	{
		...
		$arSection = CMaxCache::CIBlockSection_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ['GLOBAL_ACTIVE' => 'Y', "ID" => $sid, "IBLOCK_ID" => $arElement["IBLOCK_ID"]], false, ["ID", "IBLOCK_ID", "UF_SECTION_TIZERS", "NAME", "IBLOCK_SECTION_ID", "DEPTH_LEVEL", "LEFT_MARGIN", "RIGHT_MARGIN", "UF_OFFERS_TYPE", "UF_HELP_TEXT", 'UF_LINKED_BLOG', "UF_PICTURE_RATIO"]);
	}
}
...
if (strlen((string) $arSection['UF_HELP_TEXT'])) {
...
if (!$typeTmpSKU || $sectionTizers || !$sectionHelpText || !$linkedArticles) {
	if($arSection["DEPTH_LEVEL"] > 2){
		$arSectionParent = CMaxCache::CIBlockSection_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ['GLOBAL_ACTIVE' => 'Y', "ID" => $arSection["IBLOCK_SECTION_ID"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]], false, ["ID", "IBLOCK_ID", "UF_OFFERS_TYPE", "UF_SECTION_TIZERS", 'UF_LINKED_BLOG', "UF_HELP_TEXT"]);
		...
		if (strlen((string) $arSectionParent['UF_HELP_TEXT']) && !$sectionHelpText) {
		...
		if(!$typeTmpSKU || !$sectionTizers || !$linkedArticles){
			$arSectionRoot = CMaxCache::CIBlockSection_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ['GLOBAL_ACTIVE' => 'Y', "<=LEFT_BORDER" => $arSection["LEFT_MARGIN"], ">=RIGHT_BORDER" => $arSection["RIGHT_MARGIN"], "DEPTH_LEVEL" => 1, "IBLOCK_ID" => $arParams["IBLOCK_ID"]], false, ["ID", "IBLOCK_ID", "UF_OFFERS_TYPE", "UF_SECTION_TIZERS", 'UF_LINKED_BLOG', "UF_HELP_TEXT"]);
			...
			if (strlen((string) $arSectionRoot['UF_HELP_TEXT']) && !$sectionHelpText) {
