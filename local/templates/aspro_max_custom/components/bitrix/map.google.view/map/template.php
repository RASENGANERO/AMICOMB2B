...
$arParams["CLICKABLE"] = ( $arParams["CLICKABLE"] ?: "Y" );?>
	<div class="module-map">
		<div class="map-wr module-contacts-map-layout">
			<?if( $arParams["ZOOM_BLOCK"]["HIDDEN"] != "Y" ){?>
				<div class="controls <?=( $arParams["ZOOM_BLOCK"]["POSITION"] ?: 'left' )?>">
					<div class="z zoomIn">+</div>
					<div class="z zoomOut">-</div>
				</div>
			<?}?>
			<?$APPLICATION->IncludeComponent('bitrix:map.google.system', '.default', $arTransParams, false, ['HIDE_ICONS' => 'Y']);?>
		</div>
	</div>
