					...
					)
					{
						...
						if (empty($arPaySystem["ERROR"]))
						{
							...
							<table class="sale_order_full_table">
								...
								<tr>
									<td>
										<? if (strlen((string) $arPaySystem["ACTION_FILE"]) > 0 && $arPaySystem["NEW_WINDOW"] == "Y" && $arPaySystem["IS_CASH"] != "Y"): ?>
											<?
											$orderAccountNumber = urlencode(urlencode((string) $arResult["ORDER"]["ACCOUNT_NUMBER"]));
