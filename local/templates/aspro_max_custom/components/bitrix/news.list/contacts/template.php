					...
					<div class="contacts-stores shops-list1">
						<?foreach($arResult['SECTIONS'] as $arSection):?>
							...
							<?if($bHasSection):?>
								...
								$arSectionButtons = CIBlock::GetPanelButtons($arSection['SECTION']['IBLOCK_ID'], 0, $arSection['SECTION']['ID'], ['SESSID' => false, 'CATALOG' => true]);
								...
								$this->AddDeleteAction($arSection['SECTION']['ID'], $arSectionButtons['edit']['delete_section']['ACTION_URL'], CIBlock::GetArrayByID($arSection['SECTION']['IBLOCK_ID'], 'SECTION_DELETE'), ['CONFIRM' => GetMessage('CT_BNL_ELEMENT_DELETE_CONFIRM')]);?>
