...
$arParams['MOBILE_SCROLLED'] ??= 'N';
$arParams['MOBILE_BORDERED'] ??= 'N';
$arParams['COLORED_IMG'] ??= 'N';
$arParams['NARROW'] ??= 'N';
?>
<?if($arResult["ITEMS"]):?>
									...
									<div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="<?= $bMobileBordered ? 'bordered bordered--hidden-601' : '' ?>">
										<a href="<?=$arItem["DETAIL_PAGE_URL"]?>">
											<?if( is_array($arItem["PREVIEW_PICTURE"]) ){?>
												<img class="lazy" data-src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($arItem["PREVIEW_PICTURE"]["SRC"]);?>" alt="<?=($arItem["PREVIEW_PICTURE"]["ALT"] ?: $arItem["NAME"]);?>" title="<?=($arItem["PREVIEW_PICTURE"]["TITLE"] ?: $arItem["NAME"]);?>" />
											<?}elseif( is_array($arItem["DETAIL_PICTURE"]) ){?>
												<img class="lazy" data-src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($arItem["DETAIL_PICTURE"]["SRC"]);?>" alt="<?=($arItem["DETAIL_PICTURE"]["ALT"] ?: $arItem["NAME"]);?>" title="<?=($arItem["DETAIL_PICTURE"]["TITLE"] ?: $arItem["NAME"]);?>" />
											<?}else{?>
