...
$sClassList = match ($elementInRow) {
    '2' => 'col-md-6 col-sm-6 col-xs-6 col-xxs-12',
    '3' => 'col-md-4 col-sm-4 col-xs-6 col-xxs-12',
    '4' => 'col-md-3 col-sm-4 col-xs-6 col-xxs-12',
    default => 'col-md-3 col-sm-4 col-xs-6 col-xxs-12',
};
?>
<?if($arResult['ITEMS']):?>
									...
									<?if(!$bItemsTypeAlbums):?>
										<div class="gallery-list__item-text-wrapper flexbox">
											...
											<div class="gallery-list__item-text-top-part">
												...
												<div class="gallery-list__item-title">
													<a class="dark_link color-theme-target" href="<?=$detailUrl?>"><?=Loc::getMessage('ALBUM_LINK', ['#NAME#' => $arItem['NAME']])?></a>
												</div>
											</div>
										</div>
									<?endif;?>
