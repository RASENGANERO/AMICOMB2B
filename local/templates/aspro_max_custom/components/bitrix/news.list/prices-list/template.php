...
<?if($arResult['ITEMS']):?>
	...
	<?endif;?>
			...
			<?foreach($arResult['ITEMS'] as $i => $arItem):?>
				...
				$this->AddDeleteAction($arItem[$i]['ID'], $arItem[$i]['DELETE_LINK'], CIBlock::GetArrayByID($arItem[$i]['IBLOCK_ID'], 'ELEMENT_DELETE'), array('CONFIRM' => Loc::getMessage('CT_BNL_ELEMENT_DELETE_CONFIRM')));
				// use detail link?
