	...
	<div class="maxwidth-theme only-on-front">
		...
		?>
				<?foreach($arResult['ITEMS'] as $arItem):?>
					...
					$arImage = ($arItemImage ? CFile::ResizeImageGet($arItemImage, ['width' => 600, 'height' => 600], BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true) : []);
					$imageSrc = ($arItemImage ? $arImage['src'] : '');

					$bPreviewText = (isset($arItem['DISPLAY_PROPERTIES']['INDEX_TEXT']) && strlen((string) $arItem['DISPLAY_PROPERTIES']['INDEX_TEXT']['VALUE']));
