                        ...
                        <div class="lookbook-wrapper mobile-adaptive <?=($i ? 'lookbook--hidden' : '')?>" data-code="<?=$arSection['ID']?>">
                            ...
                            <div class="swipeignore mobile-overflow c_<?=count($arSection['ITEMS']);?> mobile-margin-16 mobile-compact">
                                <?foreach($arSection['ITEMS'] as $j => $arItem):?>
                                    ...
                                    // preview image
                                    $arItemImage = (strlen((string) $arItem['FIELDS']['PREVIEW_PICTURE']['SRC']) ? $arItem['FIELDS']['PREVIEW_PICTURE'] : $arItem['FIELDS']['DETAIL_PICTURE']);
                                    $arImage = ($arItemImage ? CFile::ResizeImageGet($arItemImage, ['width' => 500, 'height' => 500], BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true) : []);
                                                    ...
                                                    <div class="row margin0 flexbox">
                                                        <div class="col-md-6 col-xxs-12">
                                                            <div class="lookbook__picture-wrapper lookbook--pl-49 lookbook--pt-49 lookbook--pb-49">
                                                                ...
                                                                <?
                                                                $a_alt = (is_array($arItem["PREVIEW_PICTURE"]) && strlen((string) $arItem["PREVIEW_PICTURE"]['DESCRIPTION']) ? $arItem["PREVIEW_PICTURE"]['DESCRIPTION'] : ($arItem["IPROPERTY_VALUES"]["ELEMENT_PREVIEW_PICTURE_FILE_ALT"] ?: $arItem["NAME"] ));
                                                                $a_title = (is_array($arItem["PREVIEW_PICTURE"]) && strlen((string) $arItem["PREVIEW_PICTURE"]['DESCRIPTION']) ? $arItem["PREVIEW_PICTURE"]['DESCRIPTION'] : ($arItem["IPROPERTY_VALUES"]["ELEMENT_PREVIEW_PICTURE_FILE_TITLE"] ?: $arItem["NAME"] ));
                                                                ?>
                                                                <img data-src="<?=$arItem['FIELDS']['DETAIL_PICTURE']['SRC'];?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($imageSrc);?>" class="lookbook__picture_cust lookbook__picture lazy img-responsive lookbook--mh-500" alt="<?=$a_alt;?>" title="<?=$a_title;?>" />
