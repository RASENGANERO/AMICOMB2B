...
<?if($arParams["SHOW_INPUT"] !== "N"):?>
	<div class="inline-search-block fixed with-close big">
		<div class="search-wrapper search-maxwidth-wrapper">
			<div id="<?=$CONTAINER_ID?>">
				<form id="search-catalog-form" action="<?=$arResult["FORM_ACTION"]?>" class="search<?=($bShowSearchType ? ' search--hastype' : '')?>">
...
<script type="text/javascript">
	...
	var jsControl = new JCTitleSearch2({
		...
		'MIN_QUERY_LEN': 1,
		'TYPE_SEARCH': typeUrl,
		'SEARCH_ALL_PAGE': '<?=CUtil::JSEscape(POST_FORM_ACTION_URI)?>',
