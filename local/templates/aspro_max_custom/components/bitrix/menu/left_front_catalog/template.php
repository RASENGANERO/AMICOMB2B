	...
	<div class="menu_top_block catalog_block">
		<?if(!CMax::IsMainPage()):?>
			<div class="slide-block">
				<div class="slide-block-pad slide-block__head title-menu font-bold colored_theme_hover_bg-block darken font_upper_md<?=($_COOKIE['MENU_CLOSED'] == 'Y' ? ' closed' : '');?>" data-id="MENU">
				
				</div>
				<div class="slide-block__body">
		<?endif;?>
		<?$classMenuPosition = $arTheme["MENU_POSITION"]["VALUE"] == 'COMBINED' ? 'm_line m_combined' : 'm_' . strtolower((string) $arTheme["MENU_POSITION"]["VALUE"]);?>
