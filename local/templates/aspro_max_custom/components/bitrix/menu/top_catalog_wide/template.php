		...
		<table>
			<tr>
				<?foreach($arResult as $arItem):?>
					...
					<td class="menu-item unvisible <?=($arItem["CHILD"] ? "dropdown" : "")?> <?=($bWideMenu ? 'wide_menu' : '');?> <?=($arItem["PARAMS"]["CLASS"] ?? "");?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
						<div class="wrap">
												...
												<div class="right-content">
													<?if($bRightBanner && $arItem['PARAMS']['BANNERS']):?>
														...
														if($GLOBALS['arRegionLink']) {
															$GLOBALS['rightBannersFilter'] = array_merge( $GLOBALS['arRegionLink'], ['ID' => $arItem['PARAMS']['BANNERS']] );
														} else {
															$GLOBALS['rightBannersFilter'] = ['ID' => $arItem['PARAMS']['BANNERS']];
														}
