		...
		if($arItem["CHILD"]){
			foreach($arItem["CHILD"] as $key2=>$arChild){
				...
				if($arChild["PARAMS"]["PICTURE"]){
					$img=CFile::ResizeImageGet($arChild["PARAMS"]["PICTURE"], ['width'=>50, 'height'=>50], BX_RESIZE_IMAGE_PROPORTIONAL, true);
