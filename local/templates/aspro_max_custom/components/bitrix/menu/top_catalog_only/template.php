		...
		<table>
			<tr>
				<?foreach($arResult as $arItem):?>
					...
					$bWideMenu = ($arItem["PARAMS"]['FROM_IBLOCK'] || str_contains((string) $arItem["PARAMS"]["CLASS"], 'wide_menu'));
					if(!$arItem['TEXT']) continue;?>
					<td class="menu-item <?=($arItem["CHILD"] ? "dropdown" : "")?> <?=($bWideMenu ? 'wide_menu' : '');?> <?=($arItem["PARAMS"]["CLASS"] ?? "");?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
						<div class="wrap">
