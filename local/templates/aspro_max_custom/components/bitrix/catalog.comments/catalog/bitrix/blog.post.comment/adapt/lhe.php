	...
	function CustomizeLHEForBlogComments()
	{
		...
		window.LHEDailogs['BlogImage'] = function(pObj)
		{
			var str =
				...
				'<td colSpan="2" style="padding: 0 0 20px 25px !important; font-size: 11px!important;"><?= GetMessageJS('BPC_IMAGE_SIZE_NOTICE', ['#SIZE#' => DoubleVal(COption::GetOptionString("blog", "image_max_size", 1000000)/1000000)])?></td>' +
			'</tr></table>';
