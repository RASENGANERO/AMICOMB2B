...
/* LIKE */
$likeValue = ($fields['UF_ASPRO_COM_LIKE']['VALUE'] ?: 0);
...
/* DISLIKE */
$dislikeValue = ($fields['UF_ASPRO_COM_DISLIKE']['VALUE'] ?: 0);
...
if($bCancelLike) {
	...
	$USER_FIELD_MANAGER->Update("BLOG_COMMENT_ID", $ufId, ['UF_LIKE_ID' => serialize($likeId)]);
	$USER_FIELD_MANAGER->Update("BLOG_COMMENT", $_REQUEST['commentId'], ['UF_ASPRO_COM_LIKE' => $likeValue]);
}
...
if($bCancelDisLike) {
	...
	$USER_FIELD_MANAGER->Update("BLOG_COMMENT_ID", $ufId, ['UF_DISLIKE_ID' => serialize($dislikeId)]);
	$USER_FIELD_MANAGER->Update("BLOG_COMMENT", $_REQUEST['commentId'], ['UF_ASPRO_COM_DISLIKE' => $dislikeValue]);
}
