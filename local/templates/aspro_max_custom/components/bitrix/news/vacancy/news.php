		...
		<div class="properties bordered">
			<?if($showForm):?>
				<div class="button_wrap pull-left">
					<span><span class="btn btn-default btn-lg animate-load" data-event="jqm" data-name="resume" data-param-form_id="<?=$arParams["FORM_ID"] ?: 'RESUME'?>" ><?=($arParams["FORM_BUTTON_TITLE"] ?: GetMessage('FORM_BUTTON_TITLE'));?></span></span>
				</div>
			<?endif;?>
				...
				<div class="row">
					...
					<div class="property item contact col-lg-5 col-md-12 col-sm-12 col-xs-12 <?=(!$showPerson ? 'hidden' : '')?>">
						...
						<div class="value darken">
							<?$APPLICATION->IncludeFile(SITE_DIR."include/vacancy_page/contact_person.php", [], [ 
			                        "MODE" => "text", 
			                        "NAME" => "contact person", 
					...
					<div class="property item email col-lg-4 col-md-6 col-sm-6 col-xs-12 <?=(!$showEmail ? 'hidden' : '')?>">
						...
						<div class="value darken">
							<?$APPLICATION->IncludeFile(SITE_DIR."include/vacancy_page/contact_email.php", [], [ 
			                        "MODE" => "text", 
			                        "NAME" => "contact email", 
			                        "TEMPLATE" => "include_area.php", 
			                    ] 
					...
					<div class="property item phone col-lg-3 col-md-6 col-sm-6 col-xs-12 <?=(!$showPhone ? 'hidden' : '')?>">
						...
						<div class="value darken">
							<?$APPLICATION->IncludeFile(SITE_DIR."include/vacancy_page/contact_phone.php", [], [ 
			                        "MODE" => "text", 
			                        "NAME" => "contact phone", 
			                        "TEMPLATE" => "include_area.php", 
			                    ] 
			...
			<div class="detailtext <?=(!$showDetailText ? 'hidden' : '')?>">
				<?$APPLICATION->IncludeFile(SITE_DIR."include/vacancy_page/contact_detail.php", [], [ 
                        "MODE" => "text", 
                        "NAME" => "contact detail", 
                        "TEMPLATE" => "include_area.php", 
                    ] 
