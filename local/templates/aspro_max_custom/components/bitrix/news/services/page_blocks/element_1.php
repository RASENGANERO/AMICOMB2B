<?$APPLICATION->IncludeComponent(
	...
	[
		...
		"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ?: 'tizers,desc,char,docs,services,news,blog,vacancy,reviews,projects,staff,landings,comments'),
		...
		"IS_AJAX_SECTIONS" => (strtolower((string) $_REQUEST['ajax_get_sections']) == 'y'),
		"FROM_AJAX" => (CMax::checkAjaxRequest() && strtolower((string) $_REQUEST['ajax']) == 'y'),
		...
		"SHOW_GALLERY" => $arParams["SHOW_GALLERY_GOODS"] ?? "N",
