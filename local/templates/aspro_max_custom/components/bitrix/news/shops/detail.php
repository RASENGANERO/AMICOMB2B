...
if($arResult["VARIABLES"]["ELEMENT_ID"] > 0){
	$arElement = CMaxCache::CIBLockElement_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ["IBLOCK_ID" => $arParams["IBLOCK_ID"], "ACTIVE"=>"Y", "ID" => $arResult["VARIABLES"]["ELEMENT_ID"]], false, false, ["ID", "IBLOCK_SECTION_ID", "PREVIEW_TEXT", "PREVIEW_PICTURE", "DETAIL_PICTURE"]);
}
elseif(strlen(trim((string) $arResult["VARIABLES"]["ELEMENT_CODE"])) > 0){
	$arElement = CMaxCache::CIBLockElement_GetList(['CACHE' => ["MULTI" =>"N", "TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"])]], ["IBLOCK_ID" => $arParams["IBLOCK_ID"], "ACTIVE"=>"Y", "=CODE" => $arResult["VARIABLES"]["ELEMENT_CODE"]], false, false, ["ID", "IBLOCK_SECTION_ID", "PREVIEW_TEXT", "PREVIEW_PICTURE", "DETAIL_PICTURE"]);
}
?>
