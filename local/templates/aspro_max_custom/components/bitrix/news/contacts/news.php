						...
						<div class="row">
							<div class="col-lg-6 col-md-4 col-sm-6">
								<select class="<?=($bHasChildSections ? 'region' : 'city');?>">
									<option value="0" selected><?=Loc::getMessage('CHOISE_ITEM', ['#ITEM#' => ($bHasChildSections ? Loc::getMessage('REGION') : Loc::getMessage('CITY'))])?></option>
							...
							<?if($bHasChildSections):?>
								<div class="col-lg-6 col-md-4 col-sm-6">
									<select class="city">
										<option value="0" selected><?=Loc::getMessage('CHOISE_ITEM', ['#ITEM#' => Loc::getMessage('CITY')])?></option>
