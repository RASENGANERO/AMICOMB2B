...
$arElement = CMaxCache::CIblockElement_GetList(["CACHE" => ["TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "N"]], $arItemFilter, false, false, ['ID', 'PREVIEW_TEXT', 'IBLOCK_SECTION_ID', 'PREVIEW_PICTURE', 'DETAIL_PICTURE']);
?>
<?}else{
	if(\Bitrix\Main\Loader::includeModule('catalog'))
	{
		$arElement = CCatalogStore::GetList(['ID' => 'ASC'], ['ID' => $arResult['VARIABLES']['ELEMENT_ID']], false, false, ["ID"])->Fetch();
	}
}?>
