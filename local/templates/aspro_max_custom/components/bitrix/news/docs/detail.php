...
$arElement = CMaxCache::CIblockElement_GetList(["CACHE" => ["TAG" => CMaxCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]), "MULTI" => "N"]], $arItemFilter, false, false, ["ID", 'PREVIEW_TEXT', "IBLOCK_SECTION_ID", 'DETAIL_PICTURE', 'DETAIL_PAGE_URL', 'PROPERTY_LINK_PROJECTS', 'PROPERTY_LINK_REVIEWS', 'PROPERTY_DOCUMENTS']);
?>
...
<?else:?>
	...
	<?if(in_array('LINK_REVIEWS', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_LINK_REVIEWS_VALUE']):?>
		<div class="wraps reviews-block">
			<hr />
			<h5><?=(strlen((string) $arParams['T_REVIEWS']) ? $arParams['T_REVIEWS'] : GetMessage('T_REVIEWS'))?></h5>
			<?global $arrrFilter; $arrrFilter = ["ID" => $arElement["PROPERTY_LINK_REVIEWS_VALUE"]];?>
	...
	<?if(in_array('LINK_PROJECTS', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_LINK_PROJECTS_VALUE']):?>
		<div class="wraps projects-block">
			<hr />
			<h5><?=(strlen((string) $arParams['T_PROJECTS']) ? $arParams['T_PROJECTS'] : GetMessage('T_PROJECTS'))?></h5>
			<?$GLOBALS['arrProjectFilter'] = ['ID' => $arElement['PROPERTY_LINK_PROJECTS_VALUE']];?>
			<?$APPLICATION->IncludeComponent(
				"bitrix:news.list",
				"items-row",
				[
					...
					"COUNT_IN_LINE" => "3",
					"SHOW_TITLE" => "Y",
					"T_PROJECTS" => ($arParams["T_PROJECTS"] ?: Loc::getMessage("T_PROJECTS")),
					"AJAX_OPTION_ADDITIONAL" => ""
				],
				false, ["HIDE_ICONS" => "Y"]
			);?>
	...
	<?if(in_array('DOCUMENTS', $arParams['DETAIL_PROPERTY_CODE']) && $arElement['PROPERTY_DOCUMENTS_VALUE']):?>
		<div class="wraps docs-block">
			<hr />
			<h5><?=(strlen((string) $arParams['T_DOCS']) ? $arParams['T_DOCS'] : Loc::getMessage('T_DOCS'))?></h5>
			<div class="row">
