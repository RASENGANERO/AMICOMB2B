		...
		<div class="region_wrapper">
			<div class="io_wrapper">
				...
				<?if (
					...
					<div class="js_city_chooser animate-load dark-color" data-event="jqm" data-name="city_chooser" data-param-url="<?=urlencode((string) $APPLICATION->GetCurUri());?>" data-param-form_id="city_chooser">
