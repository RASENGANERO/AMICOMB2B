...
<?if(!$arResult['POPUP']):?>
	<?if(
		...
		(
			!$arResult['USE_REGIONALITY'] &&
			$arResult['SHOW_CITY'] &&
			strlen((string) $arResult['CURRENT_REGION_TITLE_IN_HEADER'])
		)
	):?>
		<div class="region_wrapper">
			<div class="io_wrapper">
				...
				<?if (
					...
					<div class="js_city_chooser  animate-load  io_wrapper" data-event="jqm" data-name="city_chooser_small" data-param-url="<?=urlencode((string) $APPLICATION->GetCurUri());?>" data-param-form_id="city_chooser">
