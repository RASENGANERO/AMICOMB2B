...
$arParams['API_TOKEN_VK'] ??= '';
$arParams['GROUP_ID_VK'] ??= '';
$arParams['TITLE'] ??= '';
$arParams['RIGHT_TITLE'] ??= '';
$arParams['SHOW_TITLE'] ??= false;
$arParams['ELEMENTS_ROW'] ??= 4;
$arParams['VK_TEXT_LENGTH'] ??= null;
$arParams['BORDERED'] ??= '';
$arParams['VIEW_TYPE'] ??= '';
$arParams['LINE_ELEMENT_COUNT'] ??= 4;
$arParams['PAGE_ELEMENT_COUNT'] ??= 4;
$arParams['NO_MARGIN'] ??= 'N';
$arParams['WIDE_BLOCK'] ??= 'N';
$arParams['WIDE_FIRST_BLOCK'] ??= 'N';
