...
$arParamsTmp = $signer->signParameters($this->__component->getName(), array_filter($arParams, fn ($key) => !str_starts_with((string) $key, '~'), ARRAY_FILTER_USE_KEY));

$isAjax = isset($_REQUEST['ajax']) && strtolower((string) $_REQUEST['ajax']) === 'y';
