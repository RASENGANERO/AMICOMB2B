					...
					<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
						<div class="bx_filter_parameters">
							...
							<?if ($arParams["~htmlSections"] && $arParams["TOP_VERTICAL_FILTER_PANEL"] == "N"):?>
								...
								if(preg_match_all('/PAGEN_\d+/i'.BX_UTF_PCRE_MODIFIER, (string) $_SERVER['QUERY_STRING'], $arMatches)){
							...
							foreach($arResult["ITEMS"] as $key=>$arItem)
							{
								...
								$isFilter=true;
								?>
								<div class="bx_filter_parameters_box <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ?: "N");?>" data-prop_code=<?=strtolower((string) $arItem["CODE"]);?> data-property_id="<?=$arItem["ID"]?>" data-property_name="<?=$arItem["NAME"]?>">
									<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
									<?if(!$arItem["IS_PROP_INLINE"]){?>
										<div class="bx_filter_parameters_box_title colored_theme_hover_bg-block" >
											<div>
