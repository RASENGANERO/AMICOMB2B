...
<?
use Amikomnew;
$resMainSection = Amikomnew\BrandsDetail::getMainSectionBrand($arParams['BRAND_CODE']);
?>
		...
		<div class="">
			<?if($arResult["SECTIONS"]):?>
				<div class="section-detail-list__item item font_xs " >
					<div class="section-detail-list__info bordered box-shadow-sm rounded3 all-sections section-detail-list__item--active colored_theme_bg" data-brand-code="<?=$arParams['BRAND_CODE']?>" data-section_id="<?=$resMainSection?>" data-section_reset="false">
			...
			?>
				...
				<div class="section-detail-list__item item font_xs " id="<?=$this->GetEditAreaId($arItems['ID']);?>">
					<div>
						<div class="section-detail-list__info bordered  box-shadow-sm rounded3" data-brand-code="<?=$arParams['BRAND_CODE']?>" data-section_id="<?=$arItems["ID"]?>" data-section_reset="false">
...
<?}?>
<a id="show-products-brand" class="brand-product-url-not">Просмотреть товары <?=$arParams['BRAND_NAME']?></a>