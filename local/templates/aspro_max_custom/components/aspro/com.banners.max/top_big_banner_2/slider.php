												...
												<?if($bShowButton1 || $bShowButton2 || ($bShowVideo && !$bVideoAutoStart)):?>
													<div class="banner_buttons">
														...
														<?elseif($bShowButton1 || $bShowButton2):?>
															...
															<?endif;?>
															<?if($bShowButton2):?>
																<a href="<?=$arItem["PROPERTIES"]["BUTTON2LINK"]["VALUE"]?>" class="<?=!empty( $arItem["PROPERTIES"]["BUTTON2CLASS"]["VALUE"]) ? $arItem["PROPERTIES"]["BUTTON2CLASS"]["VALUE"] : "btn btn-transparent-border btn-lg"?>" <?=(strlen((string) $target) ? 'target="'.$target.'"' : '')?>>
									...
									<td class="img <?=($bHasVideo ? 'with_video' : '');?>">
										...
										<?elseif($arItem["PREVIEW_PICTURE"]):?>
											<?if(!empty($arItem["PROPERTIES"]["URL_STRING"]["VALUE"])):?>
												<a href="<?=$arItem["PROPERTIES"]["URL_STRING"]["VALUE"]?>" <?=(strlen((string) $target) ? 'target="'.$target.'"' : '')?>>
											<?endif;?>
											<img class="plaxy lazy" data-src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" src="<?=\Aspro\Functions\CAsproMax::showBlankImg($arItem['PREVIEW_PICTURE']['SRC'])?>" alt="<?=($arItem['PREVIEW_PICTURE']['ALT'] ?: $arItem['NAME'])?>" title="<?=($arItem['PREVIEW_PICTURE']['TITLE'] ?: $arItem['NAME'])?>" />
											<?if(!empty($arItem["PROPERTIES"]["URL_STRING"]["VALUE"])):?>
												</a>
											<?endif;?>
										<?endif;?>									
