...
$callbackExploded = explode(',', (string) $arTheme['SHOW_CALLBACK']['VALUE']);
$bShowCallBackBlock = (in_array('INNER_MENU', $callbackExploded));
$questionExploded = explode(',', (string) $arTheme['SHOW_QUESTION']['VALUE']);
$bShowQuestionBlock = (in_array('INNER_MENU', $questionExploded));
$reviewExploded = explode(',', (string) $arTheme['SHOW_REVIEW']['VALUE']);
