...
<div class="mobilemenu-v1 scroller">
	...
	<div class="wrap">
		...
		<div class="menu middle mobile-menu-contacts">
			<ul>
				<li>
					<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/mobile-menu/site-phone.php", array(), array(
							"MODE" => "html",
							"NAME" => "Phone",
		...
		<div class="contacts">
			...
			<div class="address">
				...
				<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/mobile-menu/site-address.php", array(), array(
						"MODE" => "html",
						"NAME" => "Address",
						"TEMPLATE" => "include_area.php",
					)
			...
			<div class="email">
				...
				<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/mobile-menu/site-email.php", array(), array(
						"MODE" => "html",
						"NAME" => "Email",
						"TEMPLATE" => "include_area.php",
					)
