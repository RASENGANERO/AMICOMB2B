				...
				<div class="right_menu_block">
					<div class="contact_wrap">
						<div class="info">
							<div class="phone blocks">
								<div class="">
								<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/header/site-phone.php", array(), array(
									"MODE" => "html",
									"NAME" => "Phone",
									"TEMPLATE" => "include_area.php",
								)
					...
					<div class="footer_wrap">
						...
						<div class="email blocks color-theme-hover">
							...
							<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/burger-menu/site-email.php", array(), array(
									"MODE" => "html",
									"NAME" => "Email",
									"TEMPLATE" => "include_area.php",
								)
						...
						<div class="address blocks">
							...
							<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/burger-menu/site-address.php", array(), array(
									"MODE" => "html",
									"NAME" => "Address",
									"TEMPLATE" => "include_area.php",
								)
