							...
							<div class="row">
								...
								<div class="col-md-12 col-sm-12">
									<div class="phone-custom blocks">
										...
										<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/footer/site-phone.php", [], [
												"MODE" => "html",
												"NAME" => "Phone",
								...
								<div class="col-md-12 col-sm-12">
									<div class="email blocks">
										...
										<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/footer/site-email.php", [], [
												"MODE" => "html",
												"NAME" => "Email",
												"TEMPLATE" => "include_area.php",
											]
								...
								<div class="col-md-12 col-sm-12">
									<div class="address blocks">
										...
										<?$APPLICATION->IncludeFile(SITE_DIR."/local/include/footer/site-address.php", [], [
												"MODE" => "html",
												"NAME" => "Address",
												"TEMPLATE" => "include_area.php",
											]
			...
			<div class="maxwidth-theme">
				<div class="footer-bottom__items-wrapper">
					<div class="footer-bottom__item copy font_xs">
						<?$APPLICATION->IncludeFile(SITE_DIR."include/footer/copy/footer_act.php", [], [
								"MODE" => "php",
								"NAME" => "FooterAct",
								"TEMPLATE" => "include_area.php",
							]
