...
$APPLICATION->SetTitle("Подобор комплекта системы контроля и управления");
?>
<div class="select-complect-maincontainer">
	<div class="select-complect-container">
		...
		<a class="complect-url-active select-complect-url" href="/select-complect/access/">Подбор системы контроля и управления доступом</a>
	</div>
	<div class="select-comp-form">
	<?$APPLICATION->IncludeComponent(
		"bitrix:form.result.new",
		"select-complect-access-inline",
			Array(
				"AJAX_MODE" => "Y",
